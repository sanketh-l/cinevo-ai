      ...
      <header className="flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 border-b border-white/5">
        <div className="flex items-center gap-2 sm:gap-3">
          <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-gradient-to-br from-violet-500 to-fuchsia-500 flex items-center justify-center">
            <Clapperboard className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-white" />
          </div>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center h-64 text-center px-4">
            <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-white/5 flex items-center justify-center mb-4">
              <Film className="w-7 h-7 sm:w-8 sm:h-8 text-white/20" />
            </div>
            <h3 className="text-white/60 text-base sm:text-lg font-medium mb-1">No projects yet</h3>
            <p className="text-white/30 text-xs sm:text-sm">Create your first project to start generating videos</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-4">
            {projects.map((project) => (
              <div
                ...
                className="group relative bg-[#161616] rounded-2xl border border-white/5 p-4 sm:p-5 cursor-pointer transition-all hover:border-white/15 hover:bg-[#1a1a1a]"
              >
                <div className="flex items-start justify-between mb-3">
                  <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-br from-violet-500/20 to-fuchsia-500/20 flex items-center justify-center">
                    <Film className="w-4 h-4 sm:w-5 sm:h-5 text-violet-400" />
                  </div>
                  <button
                ...
                <h3 className="text-white font-medium mb-1 truncate text-sm sm:text-base">{project.name}</h3>
                <div className="flex items-center gap-2 sm:gap-3 text-[10px] sm:text-xs text-white/30">
